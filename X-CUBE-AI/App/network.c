...
#define AI_TOOLS_DATE_TIME   "Tue Jan 13 20:29:14 2026"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  7, 0x0,
  AI_SHAPE_INIT(4, 1, 4, 10, 64), AI_STRIDE_INIT(4, 4, 4, 16, 160),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  11, 0x0,
  AI_SHAPE_INIT(4, 64, 1, 1, 8), AI_STRIDE_INIT(4, 4, 256, 256, 256),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    pool_3_output_array.data = AI_PTR(g_network_activations_map[0] + 1152);
    pool_3_output_array.data_start = AI_PTR(g_network_activations_map[0] + 1152);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    dense_5_weights_array.data = AI_PTR(g_network_weights_map[0] + 15136);
    dense_5_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 15136);
    
    dense_5_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_5_bias_array.data = AI_PTR(g_network_weights_map[0] + 23776);
    dense_5_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 23776);
